...
from hangman import three_worded_list, four_worded_list, five_worded_list, six_worded_list, seven_worded_list, eight_worded_list
from hangman import word_list
from hangman import welcome_options, check, game_setup
...
photos = [
    PhotoImage(file="Skrivbord/hello-python/Hangman_img/hang0.png"), PhotoImage(
        file="Skrivbord/hello-python/Hangman_img/hang1.png"),
    PhotoImage(file="Skrivbord/hello-python/Hangman_img/hang2.png"), PhotoImage(
        file="Skrivbord/hello-python/Hangman_img/hang3.png"),
    PhotoImage(file="Skrivbord/hello-python/Hangman_img/hang4.png"), PhotoImage(
        file="Skrivbord/hello-python/Hangman_img/hang5.png"),
    PhotoImage(file="Skrivbord/hello-python/Hangman_img/hang6.png"), PhotoImage(
        file="Skrivbord/hello-python/Hangman_img/hang7.png"),
    PhotoImage(file="Skrivbord/hello-python/Hangman_img/hang8.png"), PhotoImage(
        file="Skrivbord/hello-python/Hangman_img/hang9.png"),
    PhotoImage(file="Skrivbord/hello-python/Hangman_img/hang10.png"), PhotoImage(
        file="Skrivbord/hello-python/Hangman_img/hang11.png")
]
